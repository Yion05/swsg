...
export const ContactHero = () => {
  const { t } = useTranslation("contact");
  const location = "1 N Bridge Rd, #06-16 High Street Centre, Singapore 179094";
  ...
  return (
    <section className="relative bg-cover py-8 bg-center flex flex-col gap-12 md:gap-0 md:flex-row px-8 items-center justify-around text-center bg-button">
      ...
      <section className="flex flex-col gap-2">
        ...
        <div>
          <p className="font-medium text-sm text-nowrap text-center text-white">{t(location)}</p>
        </div>
      </section>
    </section>
  );
